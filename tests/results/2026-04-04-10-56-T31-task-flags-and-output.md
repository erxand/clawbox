...
[10:56:02] Phase 1: Source audit — confirm all flags parsed in cmd_task
...
[10:56:02] Phase 2: Flag acceptance — each flag accepted (non-blocking, fast return)
[10:56:02] Phase 2a: clawbox task --retry 1 ...
  ✓ Phase 2a: --retry 1 accepted; task started
  ✓ Phase 2b: 'retry' mentioned in startup output when --retry N > 0
[10:56:14] Phase 2c: clawbox task --session ...
  ✓ Phase 2c: --session accepted; task started
  ✓ Phase 2d: session name 't31-session-test' in startup output
[10:56:22] Phase 2e: clawbox task --thinking minimal ...
  ✓ Phase 2e: --thinking minimal accepted; task started
[10:56:36] Phase 3: Output format — startup fields
[10:56:36] Phase 3a: task startup output contains Log: line
  ✓ Phase 3a: Log path shown in startup output (/Users/arclo/.clawbox-task-20260404-105636.log)
  ✓ Phase 3b: ~/.clawbox-task.log symlink exists → /Users/arclo/.clawbox-task-20260404-105636.log
  ✓ Phase 3c: 'task-logs' hint in startup output
  ✓ Phase 3d: 'task-status' hint in startup output
[10:56:46] Phase 4: Error paths — invalid flag values rejected
[10:56:46] Phase 4a: --retry with no value
  ✓ Phase 4a: --retry with no value exits non-zero
  ✓ Phase 4b: usage hint shown for --retry with no value
[10:56:46] Phase 4c: --timeout with non-numeric value
  ✓ Phase 4c: --timeout with non-numeric value exits non-zero
  ✓ Phase 4d: usage hint shown for --timeout with non-numeric value
[10:56:46] Phase 4e: --retry with non-numeric value
  ✓ Phase 4e: --retry with non-numeric value exits non-zero
[10:56:46] Phase 5: Flag parity between run and task
  ✓ Phase 5a: --retry implemented in BOTH cmd_run and cmd_task
  ⚠ Phase 5b: --timeout parity check: run refs=0
0, task refs=5
  ⚠ Phase 5c: --quiet/--json present in cmd_task — unexpected (task should write to log)
[10:56:46] Phase 6: Help text coverage
...
[10:56:46] Phase 7: --retry 0 and edge cases
[10:56:46] Phase 7a: --retry 0 accepted
  ✓ Phase 7a: --retry 0 accepted; task started
  ✓ Phase 7b: 'Retry:' correctly omitted for --retry 0
[10:56:52] Phase 8: Combined flags — multiple flags together
[10:56:52] Phase 8a: --session + --retry combined
...
[10:57:01] Phase 8d: --thinking + --retry + message (3-flag combo)
...
**Verdict: PASS with warnings — 31/33 pass, 2 warn, 0 fail ⚠️**
